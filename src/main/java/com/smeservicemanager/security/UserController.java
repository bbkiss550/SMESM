...
public class UserController {
    ...
    @PostMapping("/{id}") public String update(@PathVariable Long id,@RequestParam String firstName,@RequestParam String lastName,@RequestParam(required=false) String phone,@RequestParam(required=false) String email,@RequestParam Long roleId,RedirectAttributes r){service.update(id,firstName,lastName,phone,email,roleId);r.addFlashAttribute("successMessage","แก้ไขข้อมูลผู้ใช้งานแล้ว");return "redirect:/users";}
